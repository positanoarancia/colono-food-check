...
* [x] 공식 병원 안내문 공통 기준을 바탕으로 bulk catalog를 추가하고 `food 423개 / alias 87개 / source 13개`까지 대량 확장
...
* [x] bulk seed smoke test 추가로 `300개 이상 / 대표 음식 포함 / alias 중복 없음 / 병원 source 10곳 이상` 조건을 자동 검증
...
2. alias 대량 보강 2차
3. 참고 근거 링크 dedupe 보강
4. SearchLog 운영 루프 재시작
5. production 실기기 확인
