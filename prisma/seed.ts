...
const coreFoodAliases = [
  ...
  ["food_clear_broth", "맑은육수"],
  ["food_clear_broth", "맑은 국물"],
  ["food_clear_broth", "맑은 육수"],
  ["food_clear_broth", "멸치육수"],
  ["food_clear_broth", "장국"],
  ["food_clear_soup", "맑은국"],
  ["food_hospital_direct_soft_protein_1", "계란 음식"],
  ["food_hospital_direct_soft_protein_2", "두부 음식"],
  ["food_hospital_direct_liquid_1", "국물 음식"],
